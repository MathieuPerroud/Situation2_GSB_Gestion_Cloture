...
{
    /// <summary>
    /// DataAccess est une classe dans laquelle toutes les méthodes d'accès aux données,
    /// de la base de donnée gsb_frais, sont inscrites.
    /// C'est à partir de cette base qu'on va contrôler l'accès aux données de la base.
    /// </summary>
